...
impl UserRepository {
    ...
    pub async fn find_by_username(pool: &Pool<Postgres>, username: &str) -> Result<Option<User>, sqlx::Error> {
    ...
    pub async fn update_last_login(pool: &Pool<Postgres>, user_id: &str, last_login: DateTime<Utc>) -> Result<(), sqlx::Error> {
    ...
    pub async fn username_exists(pool: &Pool<Postgres>, username: &str) -> Result<bool, sqlx::Error> {
